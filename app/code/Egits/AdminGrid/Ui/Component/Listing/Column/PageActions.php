<?php
namespace Egits\AdminGrid\Ui\Component\Listing\Column;


use Egits\AdminGrid\Block\Adminhtml\Page\Grid\Renderer\Action\UrlBuilder;
...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'promotionslider/promotion/edit';
    const CMS_URL_PATH_DELETE = 'promotionslider/promotion/delete';

    /**
     * @var \Egits\AdminGrid\Block\Adminhtml\Page\Grid\Renderer\Action\UrlBuilder
     */
