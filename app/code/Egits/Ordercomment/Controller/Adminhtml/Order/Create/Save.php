<?php
namespace Egits\Ordercomment\Controller\Adminhtml\Order\Create;
    ...
    public function execute()
    {
        ...
        try {
            ...
            $order = $this->_getOrderCreateModel()
                ...
                // echo "<pre>";
                // $num= $this->getRequest()->getPost('egits_order_comment');
                // print_r($num);
                // die;

                $comment= $this->getRequest()->getPost('egits_order_comment');
                $order->setData('egits_order_comment',$comment);
                $order->save();
