<?php
namespace Egits\CustomCustomerField\Setup\Patch\Data;
 ...
 */
class CustomField implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        try {
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(CustomerMetadataInterface::ENTITY_TYPE_CUSTOMER, 'custom_age');
